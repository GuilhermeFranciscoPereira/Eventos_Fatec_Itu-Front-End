...
import type { ParticipantProps } from '@/@Types/ParticipantsTypes';
...
export default function Participants(): React.ReactElement {
    ...
    const schemaTable = [
        ...
        { id: 'email', header: 'Email', accessor: (p: ParticipantProps) => p.email },
        {
            id: 'ra',
            header: 'RA',
            accessor: (participant: ParticipantProps) => participant.ra || '-',
        },
        {
            id: 'createdAt',
            header: 'Inscrito em',
            accessor: (p: ParticipantProps) => new Date(p.createdAt).toLocaleString('pt-BR').replace(',', ' - '),
        },
        {
            id: 'isPresent',
            header: 'Presença',
        ...
        <main className={styles.participantsPage}>
            ...
            <div id='idParticipantsTable'>
                <Table<ParticipantProps>
                    ...
                    hiddenOnMobile={['email', 'createdAt']}
                />
            </div>
        </main>
    );
